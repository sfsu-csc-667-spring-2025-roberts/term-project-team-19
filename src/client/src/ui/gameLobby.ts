...
import { GameManager, GameLobbyItem } from "../game/game";
...
export class GameLobbyUI {
  ...
  private initialize(): void {
    // Add auth listener
    this.auth.addAuthListener(this.handleAuthChange.bind(this));
  ...
  private handleAuthChange(user: any): void {
    if (!user) {
  ...
  private createGameList(): HTMLElement {
  ...
  private createGameItem(game: GameLobbyItem): HTMLElement {
  ...
  private createCreateGameDialog(): HTMLElement {
